...
#define MATRIX_COL_PINS \
    { A8, A9, A10, A11, A12, A13, A14, A15, B0, B1, B2, B3, B4, B5, B6, B7, B8 }
...
#define RGB_MATRIX_STARTUP_MODE RGB_MATRIX_CUSTOM_ws_alpha_mods
...
#define ENABLE_RGB_MATRIX_CUSTOM_ws_alpha_mods
